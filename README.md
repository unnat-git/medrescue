...
- **Hospitals & Drivers**: Managed via seed scripts (`seed-hospitals.ts`) to maintain a registry of service providers.
...
### Backend (`/backend`)
- `src/index.ts`: Main entry point (Server & Socket.IO initialization).
